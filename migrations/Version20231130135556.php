 ...
 */
final class Version20231130135556 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE motherbrain_subscription_plan (id INT AUTO_INCREMENT NOT NULL, gateway_config_id INT DEFAULT NULL, product_id INT DEFAULT NULL, code VARCHAR(255) NOT NULL, enabled TINYINT(1) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_CD4DA5A477153098 (code), INDEX IDX_CD4DA5A4F23D6140 (gateway_config_id), INDEX IDX_CD4DA5A44584665A (product_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE motherbrain_subscription_plan ADD CONSTRAINT FK_CD4DA5A44584665A FOREIGN KEY (product_id) REFERENCES sylius_product (id) ON DELETE SET NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE motherbrain_subscription_plan DROP FOREIGN KEY FK_CD4DA5A44584665A');
