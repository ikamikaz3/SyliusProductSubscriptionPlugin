...
namespace Tests\Motherbrain\SyliusProductSubscriptionPlugin\Behat\Context\Ui\Shop;

use Behat\Behat\Context\Context;
use Tests\Motherbrain\SyliusProductSubscriptionPlugin\Behat\Page\Shop\WelcomePageInterface;
